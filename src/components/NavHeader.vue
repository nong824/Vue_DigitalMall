      ...
      <svg style="position: absolute; width: 0; height: 0; overflow: hidden;" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
        ...
        <div class="navbar">
            <div class="navbar-left-container">
              ...
              <a href="/">
                <span class="navbar-left-container-span">数码商城</span>
              </a>
            </div>
            <div class="navbar-right-container" style="display: flex;">
              <div class="navbar-menu-container">
                ...
                <a href="javascript:void(0)" class="navbar-link" @click="showRegister=true" v-show="beforelogin">注册</a>
                <a href="./" class="navbar-link" @click="logOut" v-if="nickName">退出</a>
        ...
        <div class="md-modal modal-msg md-modal-transition" v-bind:class="{'md-show':showRegister}">
          <div class="md-modal-inner">
            <div class="md-top">
              <div class="md-title">注册成为新用户</div>
              <button class="md-close" @click="showRegister=false">Close</button>
            </div>
            <div class="md-content">
              <div class="confirm-tips">
                <div class="error-wrap">
                  <span class="error error-show" v-show="tishi">{{tishi}}</span>
                  <span class="rightTip error-show" v-show="righttishi">{{rightTip}}</span>
                </div>
                <ul>
                  <li class="regi_form_input">
                    <i class="icon IconPeople"></i>
                    <input type="text" tabindex="1" name="newusername" v-model="newuserName" class="regi_login_input regi_login_input_left" placeholder="请输入用户名" data-type="loginname">
                  </li>
                  <li class="regi_form_input noMargin">
                    <i class="icon IconPwd"></i>
                    <input type="password" tabindex="2"  name="newpassword" v-model="newuserPwd" class="regi_login_input regi_login_input_left login-input-no input_text" placeholder="请输入密码">
                  </li>
                  <li class="regi_form_input noMargin">
                    <i class="icon IconPwd"></i>
                    <input type="password" tabindex="3"  name="renewpassword" v-model="renewuserPwd" class="regi_login_input regi_login_input_left login-input-no input_text" placeholder="请确认密码">
                  </li>
                  <li class="regi_form_input">
                    <i class="icon IconPhone"></i>
                    <input type="text" tabindex="4" name="userid" v-model="newuserId" class="regi_login_input regi_login_input_left" placeholder="请输入手机号">
                  </li>
                </ul>
              </div>
              <div class="login-wrap">
                <a href="javascript:;" class="btn-login" @click="resgister">注  册</a>
              </div>
            </div>
          </div>
        </div>
...
<script>
  ...
  export default{
    ...
    methods: {
      ...
      resgister(){
        if(this.newuserName===''||this.newuserPwd===''||this.newuserId===''){
          this.tishi='请输入用户名或密码或手机号'
          this.showTishi=true
        }else{
